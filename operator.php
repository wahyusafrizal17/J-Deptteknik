    ...
    <div class="box">
        ...
        <form method="post">
            ...
            <?php if ($edit): ?>
                ...
                <a href="operator.php" class="btn">Batal</a>
            <?php else: ?>
        ...
        <table>
            ...
            <tr>
                ...
                <td class="actions">
                    <a href="operator.php?edit=<?= urlencode($op['id']) ?>" class="btn">Edit</a>
                    <a href="operator.php?hapus=<?= urlencode($op['id']) ?>" class="btn btn-danger" onclick="return confirm('Yakin hapus operator ini?')">Hapus</a>
                </td>
            </tr>
            <?php endforeach; ?>
        </table>
